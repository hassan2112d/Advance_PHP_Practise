...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
			            ...
			            <div class="app-utility-item app-user">
				            <a class="toggle" id="user-toggle" data-bs-toggle="" href="#" role="button" aria-expanded="false"><img src="assets/images/user.png" alt="img"><?php echo $_SESSION['username']; ?></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="admindashboard/adminassets/images/app-logo.svg" alt="logo"><span class="logo-text">ADMIN</span></a>
